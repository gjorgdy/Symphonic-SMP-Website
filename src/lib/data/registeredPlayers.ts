...
export const registeredPlayers: Record<string, Player> = {
	...
	mellohi: {
		nickname: 'Nightshade',
		minecraft_uuid: 'caa06a11-a7cc-4d10-8a29-9a2fa5b59b8a',
		youtube_user_id: 'UCQY9J7DF7UBGq0NPeTAFZ3w',
		twitch_user_id: '612893215'
	},
	// 16
	chirp: {
	...
	'5': {
		nickname: 'Zalores',
		minecraft_uuid: '85fd94af-4f57-4092-b357-d8b1045be4f2',
		youtube_user_id: 'UCc_hQbfKYKLIK_JUdiiKZMA',
		twitch_user_id: '550535311'
	},
	// 19
	creator_music_box: {
		nickname: 'Whimzy',
