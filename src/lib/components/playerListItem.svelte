...
<div class="grid grid-rows-1 grid-cols-[40px_1fr] items-center gap-4 w-full">
    {#if player == null}
    ...
    {:else if player.profile_picture_url != null}
        ...
        >
            ...
            <img class="absolute top-0 h-full w-full ml-px rotate-y-90 group-hover:rotate-y-0 transition-transform" src={"/assets/discs/" + player.disc + ".png"} alt="">
        </button>
    {:else}
